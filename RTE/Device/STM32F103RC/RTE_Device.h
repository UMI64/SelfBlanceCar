...
#define RTE_SDIO_CD_PORT                GPIO_PORT(2)
#define RTE_SDIO_CD_PIN                 0
...
//     <i>  Selects Port Bit
//   </e>
#define RTE_SDIO_WP_EN                  1
#define RTE_SDIO_WP_ACTIVE              1
#define RTE_SDIO_WP_PORT                GPIO_PORT(2)
#define RTE_SDIO_WP_PIN                 1
